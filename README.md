...
| Canonical store | `data/processed/solardata.db` (SQLite, 329 MiB / 20 MiB gzipped — see below) |
...
**`solardata.db` is not committed** — at 329 MiB it is far over GitHub's 100 MiB
per-file limit. `release.yml` VACUUMs it and gzips it to a **20 MiB** Release
